...
def process_file(file_path, output_path):
    ...
    excluded_ids = input_unique_ids - output_unique_ids
    
    pivot_df.to_csv(output_path, sep='|', index=False, na_rep='NA')
    
    return input_unique_ids, output_unique_ids, excluded_ids
...
if __name__ == "__main__":
    ...
    for file_path in input_dir.glob('*.csv'):
        ...
        try:
            ...
            print(f"Processed: {file_path.name} | IDs Input: {in_count} | IDs Output: {out_count} | Excluded: {excl_count}")
